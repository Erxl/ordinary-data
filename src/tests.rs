...
// fn test_contains() {
//     unsafe {
//         let mut c = StdContainer::<i32, i32>::new();
...
// fn test_iter() {
//     unsafe {
//         let mut c = StdContainer::<i32, f32>::new();
